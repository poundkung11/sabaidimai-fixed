    ...
    <View style={styles.container}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.inner}>
        ...
        <TouchableOpacity style={styles.addCard}>
          ...
          <Text style={styles.addDesc}>พวกเขาจะได้รับการแจ้งเตือนถ้าผู้ติดต่อหลักตอบกลับไม่ได้</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  contactCard: { backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border, borderRadius: 16, padding: 20, flexDirection: 'row', alignItems: 'flex-start', gap: 16, marginBottom: 24 },
  contactAvatar: { width: 48, height: 48, borderRadius: 24, backgroundColor: colors.primary10, alignItems: 'center', justifyContent: 'center' },
  ...
  addCard: { backgroundColor: colors.card, borderWidth: 2, borderStyle: 'dashed', borderColor: colors.border, borderRadius: 16, padding: 32, alignItems: 'center', marginBottom: 24 },
  addIcon: { width: 48, height: 48, borderRadius: 24, backgroundColor: colors.muted, alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  ...
  infoBox: { backgroundColor: colors.primary5, borderWidth: 1, borderColor: colors.primary20, borderRadius: 12, padding: 16 },
